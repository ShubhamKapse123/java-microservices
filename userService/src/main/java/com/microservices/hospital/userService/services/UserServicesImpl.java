...
import com.microservices.hospital.userService.externalservices.HospitalService;
import com.microservices.hospital.userService.externalservices.RatingService;
...
public class UserServicesImpl implements UserServices {
    ...
    public User getUser(String userId) {
           ...
           // Rating[] ratingarr= restTemplate.getForObject("http://RATING-SERVICE/rating/users/"+user.getUserId(), Rating[].class);
            Rating[] ratingarr=ratingService.getRatingList(user.getUserId());
...
//            Hospital hospital=restTemplate.getForObject("http://HOSPITAL-SERVICE/hospital/"+rating.getHospitalId(), Hospital.class);
                Hospital hospital = hospitalService.getHospital(rating.getHospitalId());
